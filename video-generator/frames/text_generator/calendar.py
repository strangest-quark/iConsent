...
def calendar(config, key, txnId):
    ...
    font1 = ImageFont.truetype('/Users/sn5/git/other/iConsent/video-generator/assets/fonts/OpenSans-ExtraBold.ttf', 175)
    font2 = ImageFont.truetype('/Users/sn5/git/other/iConsent/video-generator/assets/fonts/OpenSans-ExtraBold.ttf', 500)
    font3 = ImageFont.truetype('/Users/sn5/git/other/iConsent/video-generator/assets/fonts/'+config.lang_map['font']+'.ttf', 175)
    ...
    img.save(config.SB_LOGO_PATH_PREFIX+key+'-'+txnId+'.png')

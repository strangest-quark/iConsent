...
class Frame6(object):
    ...
    def render_text6(t):
        ...
        text = gz.text(Frame6.map.get('text6'), fontfamily=Frame6.lang_map.get('font'),
                       fontsize=Frame6.lang_map.get('fontsize'), fontweight='bold', fill=BLUE, xy=(320, 40))
        text.draw(surface)
    ...
    def generate_video_part(self, txnId):
        ...
        text = mpy.VideoClip(self.render_text6, duration=self.config.DURATION)
